...
func (s *SmartContract) InvokeAnotherChaincode(ctx contractapi.TransactionContextInterface, function, amount string) error {
	argsBytes := util.ToChaincodeArgs(function, amount)
	res := ctx.GetStub().InvokeChaincode("coin-erc-20", argsBytes, "mychannel1")
	log.Printf("%v", res)
	return nil
}
